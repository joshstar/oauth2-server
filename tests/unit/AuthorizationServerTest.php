...
class AuthorizationServerTest extends \PHPUnit_Framework_TestCase
{
    public function testSetGet()
    {
        ...
        $grant = M::mock('joshstar\OAuth2\Server\Grant\GrantTypeInterface');
    ...
    {
        $this->setExpectedException('joshstar\OAuth2\Server\Exception\InvalidGrantException');
        $server = new AuthorizationServer();
    ...
    {
        $this->setExpectedException('joshstar\OAuth2\Server\Exception\UnsupportedGrantTypeException');
