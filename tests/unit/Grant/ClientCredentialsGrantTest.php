...
class ClientCredentialsGrantTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('\joshstar\OAuth2\Server\Exception\UnauthorizedClientException');
        ...
        $clientStorage->shouldReceive('get')->andThrow(
            new \joshstar\OAuth2\Server\Exception\UnauthorizedClientException()
        );
