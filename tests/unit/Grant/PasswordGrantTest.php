...
use joshstar\OAuth2\Server\Grant\PasswordGrant;
...
class PasswordGrantTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('joshstar\OAuth2\Server\Exception\ServerErrorException');
    ...
    {
        $this->setExpectedException('joshstar\OAuth2\Server\Exception\InvalidCredentialsException');
